...
Widget _builder(BuildContext context) => SizedBox();

class PexzaLogo extends StatelessWidget {
  static const double _kMaxHeight = 200.0;
  static const double _kHeight = 80.0;
  static const double _kMaxWidth = double.infinity;
  static const double _kWidth = 80.0;
  ...
  const PexzaLogo({
    ...
    this.logoHeight = _kHeight,
    this.logoWidth = _kWidth,
