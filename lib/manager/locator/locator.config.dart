...
import 'package:pexza/features/auth/data/sources/remote/auth_remote_datasource.dart'
    as _i23;
import 'package:pexza/features/auth/domain/domain.dart' as _i21;
...
import 'package:pexza/features/onboarding/presentation/manager/onboarding_cubit.dart'
    as _i12;
import 'package:pexza/manager/locator/modules/modules.dart' as _i27;
...
extension GetItInjectableX on _i1.GetIt {
  ...
  Future<_i1.GetIt> $initGetIt(
    ...
    gh.factory<_i13.PropertyRepository>(
        () => _i13.PropertyRepository(get<_i6.Dio>()));
    gh.factory<_i14.RoleCubit>(() => _i14.RoleCubit());
    gh.factory<_i15.ThemeCubit>(() => _i15.ThemeCubit());
    gh.factory<_i16.TokenVerificationCubit>(
        () => _i16.TokenVerificationCubit());
    gh.factory<_i17.ApartmentRepository>(
        () => _i17.ApartmentRepository(get<_i6.Dio>()));
    gh.factory<_i18.LandlordApartmentCubit>(() => _i18.LandlordApartmentCubit(
        get<_i17.ApartmentRepository>(),
        get<_i13.PropertyRepository>(),
        get<_i4.Connectivity>(),
        get<_i5.DataConnectionChecker>()));
    gh.factory<_i19.LandlordMergerCubit>(() => _i19.LandlordMergerCubit(
        get<_i17.ApartmentRepository>(),
        get<_i13.PropertyRepository>(),
        get<_i4.Connectivity>(),
        get<_i5.DataConnectionChecker>()));
    gh.factory<_i20.LandlordPropertyCubit>(() => _i20.LandlordPropertyCubit(
        get<_i13.PropertyRepository>(),
        get<_i17.ApartmentRepository>(),
        get<_i4.Connectivity>(),
        get<_i5.DataConnectionChecker>()));
    gh.lazySingleton<_i21.AuthFacade>(() => _i22.AuthFacadeImpl(
        get<_i23.AuthRemoteDatasource>(),
        get<_i24.AuthLocalDatasource>(),
        get<_i7.FirebaseAnalytics>(),
        get<_i10.FirebaseCrashlytics>()));
    gh.factory<_i25.AuthWatcherCubit>(
        () => _i25.AuthWatcherCubit(get<_i21.AuthFacade>()));
    gh.factory<_i26.AuthCubit>(() => _i26.AuthCubit(get<_i21.AuthFacade>()));
    gh.singleton<_i24.AuthLocalDatasource>(
        _i24.AuthLocalDatasource(get<_i3.AccessTokenManager>()));
    gh.singleton<_i23.AuthRemoteDatasource>(
        _i23.AuthRemoteDatasource(get<_i6.Dio>()));
    return this;
  }
}
