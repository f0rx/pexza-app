...
import 'package:pexza/features/auth/data/sources/remote/auth_remote_datasource.dart'
    as _i22;
import 'package:pexza/features/auth/domain/domain.dart' as _i20;
...
import 'package:pexza/features/onboarding/presentation/manager/onboarding_cubit.dart'
    as _i12;
import 'package:pexza/manager/locator/modules/modules.dart' as _i26;
...
extension GetItInjectableX on _i1.GetIt {
  ...
  Future<_i1.GetIt> $initGetIt(
    ...
    gh.factory<_i19.LandlordPropertyCubit>(() => _i19.LandlordPropertyCubit(
        get<_i13.PropertyRepository>(),
        get<_i17.ApartmentRepository>(),
        get<_i4.Connectivity>(),
        get<_i5.DataConnectionChecker>()));
    gh.lazySingleton<_i20.AuthFacade>(() => _i21.AuthFacadeImpl(
        get<_i22.AuthRemoteDatasource>(),
        get<_i23.AuthLocalDatasource>(),
        get<_i7.FirebaseAnalytics>(),
        get<_i10.FirebaseCrashlytics>()));
    gh.factory<_i24.AuthWatcherCubit>(
        () => _i24.AuthWatcherCubit(get<_i20.AuthFacade>()));
    gh.factory<_i25.AuthCubit>(() => _i25.AuthCubit(get<_i20.AuthFacade>()));
    gh.singleton<_i23.AuthLocalDatasource>(
        _i23.AuthLocalDatasource(get<_i3.AccessTokenManager>()));
    gh.singleton<_i22.AuthRemoteDatasource>(
        _i22.AuthRemoteDatasource(get<_i6.Dio>()));
    return this;
  }
}

class _$ServiceModules extends _i26.ServiceModules {}
