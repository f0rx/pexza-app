...
extension GetItInjectableX on _i1.GetIt {
  ...
  Future<_i1.GetIt> $initGetIt(
    ...
    gh.factory<_i16.LandlordApartmentCubit>(() => _i16.LandlordApartmentCubit(
        get<_i17.ApartmentRepository>(),
        get<_i18.PropertyRepository>(),
        get<_i4.Connectivity>(),
        get<_i5.DataConnectionChecker>()));
    gh.factory<_i19.LandlordMaintenanceCubit>(() =>
        _i19.LandlordMaintenanceCubit(get<_i20.LandlordMaintenanceRepository>(),
            get<_i4.Connectivity>(), get<_i5.DataConnectionChecker>()));
    gh.factory<_i21.LandlordMergerCubit>(() => _i21.LandlordMergerCubit(
        get<_i17.ApartmentRepository>(),
        get<_i18.PropertyRepository>(),
        get<_i22.MiscRepository>(),
        get<_i4.Connectivity>(),
        get<_i5.DataConnectionChecker>()));
    gh.factory<_i23.LandlordPropertyCubit>(() => _i23.LandlordPropertyCubit(
        ...
        get<_i4.Connectivity>(),
        get<_i5.DataConnectionChecker>()));
    gh.factory<_i24.TenantApartmentCubit>(() => _i24.TenantApartmentCubit(
        get<_i25.TenantApartmentRepository>(),
        get<_i4.Connectivity>(),
        get<_i5.DataConnectionChecker>()));
    gh.factory<_i26.TenantAssignmentCubit>(() => _i26.TenantAssignmentCubit(
        get<_i27.TenantAssignmentRepository>(),
        get<_i4.Connectivity>(),
        get<_i5.DataConnectionChecker>()));
    ...
    gh.singleton<_i20.LandlordMaintenanceRepository>(
        _i20.LandlordMaintenanceRepository(get<_i6.Dio>()));
    gh.singleton<_i22.MiscRepository>(_i22.MiscRepository(get<_i6.Dio>()));
    gh.singleton<_i18.PropertyRepository>(
        _i18.PropertyRepository(get<_i6.Dio>()));
    gh.singleton<_i25.TenantApartmentRepository>(
        _i25.TenantApartmentRepository(get<_i6.Dio>()));
    gh.singleton<_i27.TenantAssignmentRepository>(
        _i27.TenantAssignmentRepository(get<_i6.Dio>()));
    gh.singleton<_i29.TenantMaintenanceRepository>(
        _i29.TenantMaintenanceRepository(get<_i6.Dio>()));
    gh.singleton<_i17.ApartmentRepository>(
        _i17.ApartmentRepository(get<_i6.Dio>()));
