...
// ignore: unused_element
  _AuthState call(
      ...
      Option<AuthResponse> authStatus = const None()}) {
    return _AuthState(
      firstName: firstName,
      lastName: lastName,
...
mixin _$AuthState {
  ...
  Option<AuthResponse> get authStatus;
...
abstract class $AuthStateCopyWith<$Res> {
  ...
  $Res call(
      ...
      bool validate,
      bool passwordHidden,
      Option<AuthResponse> authStatus});
  ...
  $Res call({
    ...
    return _then(_value.copyWith(
      ...
      authStatus: authStatus == freezed
          ? _value.authStatus
          : authStatus as Option<AuthResponse>,
    ));
  }
...
class _$_AuthState extends _AuthState {
  ...
  @override
  final Option<AuthResponse> authStatus;
...
abstract class _AuthState extends AuthState {
  ...
  const factory _AuthState(
      ...
      bool validate,
      bool passwordHidden,
      Option<AuthResponse> authStatus}) = _$_AuthState;
