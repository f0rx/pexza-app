      ...
      floatingActionButton: Row(
        ...
        children: [
          FloatingActionButton(
            onPressed: () =>
                context.read<TokenVerificationCubit>().acceptAssignment(),
            elevation: 0.0,
          ...
          FloatingActionButton(
            onPressed: () =>
                context.read<TokenVerificationCubit>().rejectAssignment(),
            elevation: 0.0,
            backgroundColor: Colors.transparent,
            mini: true,
